cordova.define("onesignal-cordova-plugin.NotificationOpened", function(require, exports, module) { var OSNotification = require('./NotificationReceived').OSNotification;
